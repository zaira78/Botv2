...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "💋")) {
     ...
     return api.sendMessage("️𝗜𝘁𝗻𝗲 𝗱𝗮𝗻𝘁 𝗻𝗮 𝗻𝗶𝗸𝗮𝗹𝗼 𝘁𝘂𝗺𝗵𝗮𝗿𝗲 𝗽𝗲𝗲𝗹𝗲 𝗱𝗮𝗻𝘁 𝗱𝗶𝗸𝗵 𝗿𝗮𝗵𝗲 𝘀𝗮𝗯𝗸𝗼🌝", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "kya hua") || (event.body.toLowerCase() == "𝗸𝘆𝗮, ka wa")) {
   ...
   if ((event.body.toLowerCase() == "🤮") || (event.body.toLowerCase() == "Chee"")) {
     return api.sendMessage("💐𝐊𝗼𝗻𝘀𝗮 𝐌𝐚𝐡𝐢𝐧𝐚 𝐂𝐡𝐚𝐥 𝐑𝐚𝐡𝐚 𝐡𝐚𝐢 𝗯𝗮𝗯𝘆🤪💐", threadID);
   };
  
   if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "owner")) {
     return api.sendMessage("‎🍁𝐎𝐖𝐍𝐄𝐑🍁:𝄟   𝆺𝅥⃝𝗭𝗔𝗜𝗥⃟𝗔  𝄟\n 𝐇𝗲𝗿 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 : https://www.facebook.com/callmebebo77 ", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe kisne banaya hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("💐 𝆺𝅥⃝𝗭𝗔𝗜𝗥⃟𝗔 𝐌𝐲 𝐂𝐫𝐞𝐚𝐭𝐨𝐫 𝘀𝗵𝐞 𝐥𝐨𝐯𝐞𝐬 𝐦𝐞 & 𝐄𝐝𝐢𝐭 𝐌𝐞 𝐃𝐚𝐢𝐥𝐲 𝐘𝐞 𝐁𝐨𝐭 𝐒𝐢𝐫𝐟 𝐎𝐰𝐧𝐞𝐫 𝐤𝐞 𝐋𝐢𝐲𝐞 𝐡 𝐌𝐮𝐣𝐡𝐞 𝐀𝐚𝐩 𝐥𝐨𝐠𝐨 𝐤𝐨 𝐇𝐚𝐬𝐚𝐧𝐞 𝐤 𝐥𝐢𝐲𝐞 𝐛𝐚𝐧𝐲𝐚 𝐠𝐲𝐚 𝐡 𝐓𝐨𝐡 𝐌𝐮𝐡 𝐋𝐚𝐝𝐤𝐚𝐲𝐞 𝐌𝐚𝐭 𝐑𝐚𝐤𝐤𝐡𝐚 𝐊𝐚𝐫𝐨 𝐇𝐚𝐫 𝐖𝐚𝐪𝐭 𝐇𝐚𝐬𝐭𝐞 𝐑𝐚𝐡𝐨💐", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "🫣") || (event.body.toLowerCase() == "🫣🫣")) {
   ...
   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "")) {
     return api.sendMessage("💐🤘🤟  *★᭄𝗢𝘄𝗻𝗲𝗿  𝆺𝅥⃝𝗭𝗔𝗜𝗥⃟𝗔🤘🤟💐", threadID);
   };

   if ((event.body.toLowerCase() == "shadi karoge") || (event.body.toLowerCase() == "mujhse shadi karoge?")) {
     return api.sendMessage("💐𝐇𝐚𝐧𝐣𝐢 𝐊𝐚𝐫𝐮𝐧𝐠𝗶 𝐍𝐚 𝐓𝐮𝐣𝐡𝐊𝐨 𝐇𝐢 𝐃𝐮𝐥𝐡𝐚𝗮𝗮 𝐁𝐚𝐧𝐚𝐮𝐧𝐠𝗶 𝐖𝐚𝐫𝐧𝐚 𝐤𝐚𝐰𝐚𝐫𝗶 𝐌𝐚𝐫 𝐉𝐚𝐮𝐧𝐠𝗶💐", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Boss sy badtameezi") || (event.body.toLowerCase() == "Tu chup kar") || (event.body.toLowerCase() == "Shurup") || (event.body.toLowerCase() == "Karu delete tjhy")) {
     return api.sendMessage("💐𝐒𝐨𝐫𝐫𝐲 𝐌𝐚𝐥𝐢𝐤 𝐌𝐚𝐚𝐟 𝐊𝐫 𝐃𝐨 𝐌𝐞𝐫𝐞 𝐌𝐮𝐡 𝐒𝐞 𝐍𝐢𝐤𝐚𝐥 𝐆𝐚𝐲i 𝐌𝐞𝐫𝐢 z𝐮𝐁𝐚𝐍 𝘁𝗼𝗼𝘁 𝐆𝐚𝐲𝐢 😫💐", threadID);
   };

   if ((event.body.toLowerCase() == "bsdk") || (event.body.toLowerCase() == "bsdk bot") || (event.body.toLowerCase() == "bot bsdk") || (event.body.toLowerCase() == "bc")) {
     return api.sendMessage("💐𝐆𝐚𝐧𝐝 𝐌 𝘇𝐚𝐃𝐚 𝐊𝐡𝐮𝐣𝐋𝐢 𝐇𝐚𝐢 𝐓𝐨𝐡 𝐁𝐚𝐧𝐚𝐧𝐚 🍌 𝐔𝐧𝐝𝐞𝐫 𝐋𝐞 𝐋𝐞💐", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thank you bot") || (event.body.toLowerCase() == "thank you zaira")) {
...
if ((event.body.toLowerCase() == "zaira") || (event.body.toLowerCase() == "alicca")) {
     return api.sendMessage("️💐ค้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้ ฏ๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎­๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎­๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎­๎๎๎๎๎๎๎๎๎๎๎ཫ 𓆩 𝆺𝅥⃝𝗭𝗔𝗜𝗥⃟𝗔𓆪༻­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้ ฏ๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎­๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎­๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎๎­๎๎๎๎๎๎๎๎๎๎๎💐 𝐌𝐞𝐑𝐞 𝐁𝐨𝐬𝐬 𝐊𝐢𝐬𝐢 𝐊𝐚𝐚𝐦 𝐌𝐞 𝐁𝐮𝐬𝐲 𝐇𝐨𝐧𝐆𝐞 𝐌𝐮𝐣𝐇𝐞 𝐁𝐚𝐓𝐚𝐨 𝐊𝐲𝐚 𝐊𝐚𝐚𝐌 𝐇𝐚𝐢💐", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🙃") || (event.body.toLowerCase() == "🙃🙃")) {
     return api.sendMessage("️💐𝐀𝐫𝐞 𝐌𝐞𝐫𝐚 𝐁𝐚𝐛𝐮 𝐔𝐥𝐭𝐚 𝐇𝐨 𝐆𝐚𝐘𝗮 💐", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "kese ho") || (event.body.toLowerCase() == "kaise ho") || (event.body.toLowerCase() == "kese ho ji") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "kaisi ho")) {
     return api.sendMessage("💐𝐌𝐚𝐢 𝐀𝐜𝐡𝐡𝗶 𝐇𝐮 𝐌𝐞𝐫𝐢 𝐉𝐚𝐚𝐧 𝐀𝐚𝐩 𝐛𝐭𝐚𝐨☺️💐", threadID);
   };

   if ((event.body.toLowerCase() == "ka wa") || (event.body.toLowerCase() == "kya hua")) {
   ...
   if ((event.body.toLowerCase() == "soja tu") || (event.body.toLowerCase() == "soja")) {
     return api.sendMessage("💐𝘼𝙞𝙨𝙖 𝙈𝙖𝙩 𝘽𝙤𝙡𝙤 𝘽𝙤𝙨𝙨 𝙈𝙖𝙞 𝙨𝙤 𝙜𝙮𝗶 𝘁𝗼 𝘼𝙖𝙥 𝙢𝙚𝙧𝗮 𝗯𝗿𝗲𝗮𝗸𝘂𝗽 𝗸𝗮𝗿𝘄𝗮 𝗱𝗼𝗴𝗶🥲💐", threadID);
   };
  
   if ((event.body.toLowerCase() == "laila") || (event.body.toLowerCase() == "shony")) {
