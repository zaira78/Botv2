...
global.client = new Object({
  ...
  getTime: function (option) {
        switch (option) {
            case "seconds":
                return `${moment.tz("Asia/Islamabad").format("ss")}`;
            case "minutes":
                return `${moment.tz("Asia/Islamabad").format("mm")}`;
            case "hours":
                return `${moment.tz("Asia/Islamabad").format("HH")}`;
            case "date": 
                return `${moment.tz("Asia/Islamabad").format("DD")}`;
            case "month":
                return `${moment.tz("Asia/Islamabad").format("MM")}`;
            case "year":
                return `${moment.tz("Asia/Islamabad").format("YYYY")}`;
            case "fullHour":
                return `${moment.tz("Asia/Islamabad").format("HH:mm:ss")}`;
            case "fullYear":
                return `${moment.tz("Asia/Islamabad").format("DD/MM/YYYY")}`;
            case "fullTime":
                return `${moment.tz("Asia/Islamabad").format("HH:mm:ss DD/MM/YYYY")}`;
        }
  }
});
